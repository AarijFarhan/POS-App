                ...
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    ...
                    <div className="flex items-center lg:order-2  justify-between w-[15rem] ">
                      <div className='flex items-center bg-white mt-2'>
                        ...
                        <Link
                            to="/logout"
                            className="text-white bg-red-600 hover:bg-[#2d5030] focus:ring-4 focus:ring-orange-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 focus:outline-none"
                        >
                           Logout
                        </Link>
                    </div>
